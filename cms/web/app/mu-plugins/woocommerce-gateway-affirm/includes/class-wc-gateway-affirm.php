...
class WC_Gateway_Affirm extends WC_Payment_Gateway {
	...
	public function enqueueScripts() {
		...
		if ( $this->notValidCheckoutNonce($_GET['order_id'], $_GET['nonce']) ) {
			return;
		}
		...
		// Hardcode Cancel URL to prevent relative URL bug
		if (!str_contains($cancel_url, 'https://shop.fullswinggolf.com')) {
			$cancel_url = 'https://shop.fullswinggolf.com' . $cancel_url;
		}
